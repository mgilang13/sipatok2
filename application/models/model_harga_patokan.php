...
class Model_harga_patokan extends CI_Model
{
    ...
    public function getAll()
    {
        ...
        $id_user = $data_user['id'];
        $sql = "select a.id, a.nomor_invoice, a.tgl_invoice, b.NAMA_PERUSAHAAN, a.is_verified from invoices a, m_pbph b where a.id_pbph_pembeli = b.NPWSHUT_NO and a.id_user = '".$id_user."'";
